...
# Some examples:
# Select only measurements from this millennia 2000- 
FILTER_FILTERFILENAME_ONLYANEWMILLENNIA="newmillennia"_$FILTER_FILTEREDFILENAME
log "Filtering on only measurements taken from the start of the new millennia, writing to $FILTER_FILTERFILENAME_ONLYANEWMILLENNIA"
grep '^20[0-9][0-9]-' $CLEANER_BAREDATAFILENAME > $FILTER_FILTERFILENAME_ONLYANEWMILLENNIA
